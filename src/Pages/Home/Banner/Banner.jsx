    ...
    return (
        <div className="carousel w-full h-[600px]">
            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center pl-20 h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                ...
                <div className="absolute left-5 right-5 bottom-0 flex justify-end transform -translate-y-1/2">
